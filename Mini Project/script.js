...
$(document).ready(function(){
    ...
    //Calling functions to get specific cities
    getCityWeather('pune','#city_item_1');
    getCityWeather('mumbai','#city_item_2');
    getCityWeather('nagpur','#city_item_3');
    getCityWeather('aurangabad','#city_item_4');

    getCityWeather('delhi','#state_item_1');
    getCityWeather('varanasi','#state_item_2');
    getCityWeather('bangalore','#state_item_3');
    getCityWeather('kolkata','#state_item_4');
    
    getCityWeather('new york','#country_item_1');
    getCityWeather('melbourne','#country_item_2');
    getCityWeather('tokyo','#country_item_3');
    getCityWeather('london','#country_item_4');
